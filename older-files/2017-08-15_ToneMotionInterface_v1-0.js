...
TransportButton.onclick = function() {
  ...
  // when all audio buffers load, #TransportButton gets set to .musicIsReadyToPlay
    ...
    // TODO: if starting in middle of section, will need to set buttons for section already in progress
    // setActionButtonStates(TMScore.currentCue);
  }
    ...
    $("#ConfirmStop").click(function() {
      ...
      $("#CancelStop").remove();
      $("#TransportButton").prop("disabled", false);
      TransportButton.innerHTML = "&#8635;"; // was "play again"
...
function setActionButtonStates(cue) {
