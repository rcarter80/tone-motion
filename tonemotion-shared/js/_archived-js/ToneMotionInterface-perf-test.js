...
function updateIntroStatusLabel() {
  console.log("updateIntroStatusLabel() called");
...
function updateStatusLabels() {
  console.log("updateStatusLabels() called");
...
function addXYPadIfNoMotion() {
  console.log("addXYPadIfNoMotion() called");
...
function beginToneMotionUpdates() {
  $("#BeginToneMotionUpdates").html("beginToneMotionUpdates() called.");
...
if (typeof testToneFilter != "undefined") { console.log("yes there is a testToneFilter"); }
else { console.log("no there is no testToneFilter"); }
